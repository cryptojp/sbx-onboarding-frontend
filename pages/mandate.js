...
export default function Mandate(){
  ...
  const [message, setMessage] = useState("Completing Mandate Setup With Gocardless");
  ...
  const completeAuthorization = async event => {    
    useEffect(() => {
        ...
        const res = fetch("https://fathomless-temple-12276.herokuapp.com/gocardless/complete-mandate", {
            method: "POST",
